...
window.QuizHead.words = {
  ...
  /* ----------------------------------------------------------- canzoni --- */
  canzoni: [
    "Volare", "Azzurro", "L'italiano", "Bella ciao", "Il cielo in una stanza",
    "Con te partirò", "Sarà perché ti amo", "Maracaibo", "Gloria", "Felicità",
    "Ti amo", "Albachiara", "La canzone del sole", "Vita spericolata",
    "Acqua azzurra, acqua chiara", "Rimmel", "La cura", "Caruso",
    "Occidentali's Karma", "Zitti e buoni", "Brividi", "Soldi",
    "Laura non c'è", "Tanti auguri", "L'estate sta finendo", "Vamos a la playa",
    "Notti magiche", "La solitudine", "Almeno tu nell'universo",
    "Meraviglioso", "Destinazione Paradiso", "Bocca di rosa", "Generale",
    "Una vita da mediano", "Cuore matto", "Sapore di sale", "Vivo per lei",
    "Bohemian Rhapsody", "Yesterday", "Hey Jude", "Imagine", "Billie Jean",
    "Thriller", "Like a Prayer", "Wonderwall", "Smells Like Teen Spirit",
    "Sweet Child O' Mine", "Highway to Hell", "Stairway to Heaven",
    "Hotel California", "I Will Survive", "Dancing Queen", "Y.M.C.A.",
    "Livin' on a Prayer", "Don't Stop Believin'", "Sweet Caroline", "Africa",
    "Take On Me", "Careless Whisper", "Never Gonna Give You Up",
    "Summer of '69", "Nothing Else Matters", "Zombie", "Creep",
    "Losing My Religion", "Rolling in the Deep", "Shape of You", "Despacito",
    "Macarena", "Waka Waka", "Happy", "Uptown Funk", "Blinding Lights",
    "Bad Guy", "Shallow", "Let It Go", "Barbie Girl", "La Bamba",
    "Every Breath You Take", "We Will Rock You", "Another Brick in the Wall",
    "My Heart Will Go On"
  ],
